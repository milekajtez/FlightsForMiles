    ...
    <>
      ...
      <div className="profile-card-inf">
        ...
        <div className="profile-card-inf__item">
          ...
          <div className="profile-card-inf__txt">
            {profile.profileData.points}
          </div>
        </div>
        <div className="profile-card-inf__item">
          <div className="profile-card-inf__title">First name</div>
          <div className="profile-card-inf__txt">
            {profile.profileData.firstname !== null
        ...
        <div className="profile-card-inf__item">
          ...
          <div className="profile-card-inf__txt">
            {profile.profileData.lastname !== null
        ...
        <div className="profile-card-inf__item">
          ...
          <div className="profile-card-inf__txt">
            {profile.profileData.address !== null
        ...
        <div className="profile-card-inf__item">
          ...
          <div className="profile-card-inf__txt">
            {profile.profileData.passport !== null
              ? profile.profileData.passport
              : "None"}
          </div>
        </div>
      </div>

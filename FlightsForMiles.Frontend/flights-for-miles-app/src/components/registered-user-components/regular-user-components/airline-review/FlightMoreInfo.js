...
function FlightMoreInfo(props) {
    return (
        <Modal ariaHideApp={false} isOpen={props.flightInfoIsOpen} closeTimeoutMS={500}
            className="new-member-inner-reg" onRequestClose={() => props.setFlightInfo(!props.flightInfoIsOpen)}
            style={{
                overlay: {
            ...
            <div className="reg-box" style={{ color: "white", backgroundColor: '#202932' }}>

  ...
  return (
    <div>
      ...
      <Switch>
        <Route
          exact
          path="/avio/:username/configD"
          component={ConfigDestionation}
        />
        ...
        <Route
          exact
          path="/avio/:username/airlineReview"
          component={AirlineReview}
        />
        <Route
          exact
          path="/avio/:username/configH"
          component={HelpConfiguration}
        />
        <Route
          exact
          path="/avio/:username/avioProfile"
          component={AvioAdminProfile}
        />
      </Switch>
    </div>
  );

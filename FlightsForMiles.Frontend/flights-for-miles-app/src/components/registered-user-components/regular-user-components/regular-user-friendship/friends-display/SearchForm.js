            ...
            <div className="form-search" style={{ display: 'inline-block', marginTop: '1%' }}>
                ...
                <form onSubmit={searchFriendsForm.handleSubmit}>
                    <span className="input-container" style={{ display: 'inline-block' }}>
                        <input id="username" className="input" type="text" placeholder=" " value={usernameField.value}
                            onChange={usernameField.handleChange} />
                        <div className="cut"></div>
                        <label htmlFor="username" className="placeholder">Username</label>
                    </span>&nbsp;
                <span className="input-container" style={{ display: 'inline-block' }}>
                        <input id="firstname" className="input" type="text" placeholder=" " value={firstnameField.value}
                            onChange={firstnameField.handleChange} />
                        <div className="cut"></div>
                        <label htmlFor="firstname" className="placeholder">First name</label>
                    </span>&nbsp;
                <span className="input-container" style={{ display: 'inline-block' }}>
                        <input id="lastname" className="input" type="text" placeholder=" " value={lastnameField.value}

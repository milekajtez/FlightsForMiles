        ...
        dispatch(
          ...
          .then((response) => {
            if (response.status === 204) {
              ...
              props.setChangeTicket({
                isOpen: !props.changeTicket.isOpen,
                currentFlight: props.changeTicket.ticketID,
              });
          ...
          .catch((error) => {
            ...
            if (
              error.response.data.indexOf(
                "(Updating unsuccessfully. Server not found ticket for updating or ticket is purchased.)"
              ) !== -1
            ) {
              alert.show(
                "Updating unsuccessfully. Server not found ticket for updating or ticket is purchased.",

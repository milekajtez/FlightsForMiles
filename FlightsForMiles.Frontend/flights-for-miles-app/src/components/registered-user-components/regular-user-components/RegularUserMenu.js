        ...
        <span style={{float: "right", marginRight:"5%"}}>
            <div className="dropdown">
                ...
                <div className="dropdown-content">
                    <Link to={`/regular/${params.username}/friendship`}><i className="fas fa-user-friends"></i> Friendships</Link>
                    <Link to={`/regular/${params.username}/regProfile`}><i className="far fa-user-circle"></i> Profile</Link>

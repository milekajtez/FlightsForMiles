...
import {
  changeAirline,
  loadAirlines,
} from "../../../../redux/system-admin/airline-reg/airlineRegAction";
...
function AirlineChangeInfo(props) {
          ...
          .catch((error) => {
            ...
            if (
              error.response.data.indexOf(
                "(Updating unsuccessfully. Server not found airline for updating.)"
              ) !== -1
            ) {
              alert.show(
                "Updating unsuccessfully. Server not found airline for updating.",
  ...
  return (
    <Modal
      ariaHideApp={false}
      isOpen={props.changeInfoIsOpen}
      closeTimeoutMS={500}
      className="new-member-inner-login"
      onRequestClose={() => props.setChangeInfo(!props.changeInfoIsOpen)}
      style={{
        overlay: {
          position: "fixed",
          top: 0,
        ...
        <form onSubmit={changeAirlineForm.handleSubmit}>
          <div className="user-box">
            <input
              ...
              id="nameField"
              placeholder={props.airline.name}
            />
            <label>Name</label>
          </div>
          <div className="user-box">
            <input
              type="number"
              value={houseNumberField.value}
              required={houseNumberField.isRequired}
              onChange={houseNumberField.handleChange}
              id="houseNumberField"
              placeholder={props.airline.houseNumber}
            />
          ...
          <div className="user-box">
            <input
              ...
              id="streetField"
              placeholder={props.airline.street}
            />
            <label>Street</label>
          </div>
          <div className="user-box">
            <input
              ...
              onChange={cityField.handleChange}
              id="cityField"
              placeholder={props.airline.city}
            />
            <label>City</label>
          </div>
          <div className="user-box">
          ...
          <div className="user-box">
            <label style={{ color: "aqua" }}>Pricelist</label>
            <br></br>
            <textarea
              type="text"
              value={pricelistField.value}
              required={pricelistField.isRequired}

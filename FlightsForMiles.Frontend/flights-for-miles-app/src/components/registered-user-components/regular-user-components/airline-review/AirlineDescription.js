...
function AirlineDescription(props) {
    return (
        <Modal ariaHideApp={false} isOpen={props.descriptionIsOpen} closeTimeoutMS={500}
            className="new-member-inner-reg" onRequestClose={() => props.setDescription(!props.descriptionIsOpen)}
            style={{
                overlay: {

...
function AllQuestions() {
  ...
  const questions = useSelector((state) => state.help);
      ...
      .catch((error) => {
        ...
        if (
          error.response.data.indexOf(
            "(Deleting unsuccessfully. Question with sended id doesn't exsist.)"
          ) !== -1
        ) {
          alert.show(
            "Deleting unsuccessfully. Question with sended id doesn't exsist.",
  ...
  return (
    <div>
              ...
              <tr key={question.questionID}>
                ...
                <td>
                  <button
                    ...
                    onClick={() =>
                      setAnswerIsOpen({ open: true, currentQuest: question })
                    }
                  >
                  ...
                  <button
                    ...
                    onClick={() => deleteCurrentQuestion(question.questionID)}
                  >
      ...
      <AnswerQuestionForm
        ...
        setAnswerIsOpen={setAnswerIsOpen}
      />
    </div>
  );
}

    ...
    <span>
      <ul className="menu-bar">
        <li onClick={() => airlineReview()}>
          <i className="fas fa-plane-departure"></i> Airline review
        </li>
        <div></div>
        <li onClick={() => bookingHistory()}>
          <i className="fas fa-history"></i> Booking history
        </li>
        <div></div>
        <li onClick={() => flightBooking()}>
          <i className="fas fa-plane"></i> Flight booking
        </li>
        <div></div>
        <li onClick={() => quickBooking()}>
          <i className="fas fa-tachometer-alt"></i> Quick booking
        </li>
      </ul>
    </span>
  );

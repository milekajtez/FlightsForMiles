                ...
                helpData.allQuestions.map((question, index) => {
                    return (
                        <div className="accordion" key={index}>
                            <input type="radio" name="radio-a" id={question.questionID} defaultChecked className="accordition-input"/>
                            <label className="accordion-label" htmlFor={question.questionID}>{question.questionText}</label>

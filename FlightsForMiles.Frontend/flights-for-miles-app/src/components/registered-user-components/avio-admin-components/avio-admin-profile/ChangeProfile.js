...
import {
  changeProfileData,
  loadProfileData,
} from "../../../../redux/avio-admin/profile/profileAction";
          ...
          .catch((error) => {
            ...
            if (
              error.response.data.indexOf(
                "(Updating unsuccessfully. Server not found user.)"
              ) !== -1
            ) {
              ...
              error.response.data.indexOf(
                "(Update unsuccessfully. Alredy exsist user with entered username.)"
              ) !== -1
            ) {
              alert.show(
                "Update unsuccessfully. Alredy exsist user with entered username.",
